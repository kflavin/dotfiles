...
#alias ka="kubectl get pods -A --sort-by=.metadata.creationTimestamp | grep -v -E '^kube-system|^kubernetes-dashboard|^prometheus|^rxv-system'"
alias ka="kubectl get pods -A | grep -v -E '^kube-system|^kubernetes-dashboard|^prometheus|^rxv-system|^cert-manager|^datadog|^logging|^nginx-ingress|^qovery|^rxv-external-dns'"
